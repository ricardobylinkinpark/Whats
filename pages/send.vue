<template>
  <v-row>
    <v-col>
      <v-card elevation="7">
        <v-card class="pa-3" color="#42424" dark>Enviar Mensajes Plantilla</v-card>
        <div class="pa-5">
          <v-select
            v-model="item"
            :items="items"
          ...
          <template v-if="template">
            ...
            <div class="my-5">
              <h5 class="text-h5">Contactos</h5>
              <v-textarea
                v-model="recipients"
                outlined
                hint="Escriba aquí los números para la difusión."
                persistent-hint
              >
              </v-textarea>
            </div>
            ...
            <div v-if="template.footer" class="my-5">
              <h5 class="text-h5">Pie de Página</h5>
